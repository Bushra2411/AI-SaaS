...
import { Flag, Gem, Sparkles } from 'lucide-react';
        ...
        <div className='flex justify-start gap-4 flex-wrap'>
          <div className='flex justify-between items-center w-72 p-4 px-6 bg-white rounded-xl border border-gray-200'> 
             <div className='text-slate-600'>
              ...
              <div className='w-10 h-10 rounded-lg bg-gradient-to-br frm-[#3588f2] to-[#0BB0D7] text-white flex justify-center items-center'>
           ...
           <div className='flex justify-between items-center w-72 p-4 px-6 bg-white rounded-xl border border-gray-200'> 
             <div className='text-slate-600'>
              ...
              <div className='w-10 h-10 rounded-lg bg-gradient-to-br frm-[#FF61C5] to-[#9E53EE] text-white flex justify-center items-center'>
